...
*/
                ...
                "./node_modules/core-js/internals/define-iterator.js": function(s, f, r) {
                    ...
                    s.exports = function($, H, ue, yt, Te, nn, Nt) {
                        ...
                        }, mt = H + " Iterator", Xe = !1, le = $.prototype, _e = le[w] || le["@@iterator"] || Te && le[Te], ge = !T && _e || Oe(Te), Lt = H == "Array" && le.entries || _e, Ee, Se, De;
                        if (Lt && (Ee = u(Lt.call(new $)),
                        O !== Object.prototype && Ee.next && (!A && u(Ee) !== O && (p ? p(Ee, O) : typeof Ee[w] != "function" && g(Ee, w, D)),
                        h(Ee, mt, !0, !0),
                        A && (_[mt] = D))),
                        Te == L && _e && _e.name !== L && (Xe = !0,
                        ge = function() {
                            return _e.call(this)
                        }
                        ),
  ...
  */
    (function(Q, z) {
        (function(s, f) {
            ...
            class vt extends he {
                ...
                close() {
                    if (x.trigger(this._element, Dr).defaultPrevented)
                        return;
            ...
            class It extends gt {
                ...
                _initEvents() {
                    this._supportPointerEvents ? (x.on(this._element, Yr, e=>this._start(e)),
                    x.on(this._element, Gr, e=>this._end(e)),
                    this._element.classList.add(Qr)) : (x.on(this._element, Kr, e=>this._start(e)),
            ...
            class et extends he {
                ...
                _addEventListeners() {
                    ...
                    this._config.pause === "hover" && (x.on(this._element, so, ()=>this.pause()),
                ...
                _addTouchEventListeners() {
                    ...
                    const t = {
                        ...
                        endCallback: ()=>{
                            ...
                            this.touchTimeout = setTimeout(()=>this._maybeEnableCycle(), io + this._config.interval))
                        }
                    };
            ...
            function at(n, e, t) {
                ...
                var i = n.getBoundingClientRect()
                  , o = 1
                  , c = 1;
                e && ce(n) && (o = n.offsetWidth > 0 && st(i.width) / n.offsetWidth || 1,
            ...
            function bt(n) {
                for (var e = se(n), t = fi(n); t && Fo(t) && Ae(t).position === "static"; )
                    t = fi(t);
            ...
            function Yo(n) {
                var e, t = n.state, i = n.name, o = n.options, c = t.elements.arrow, d = t.modifiersData.popperOffsets, y = xe(t.placement), b = gn(y), M = [ne, oe].indexOf(y) >= 0, j = M ? "height" : "width";
                if (!(!c || !d)) {
            ...
            function xi(n) {
                var e, t = n.popper, i = n.popperRect, o = n.placement, c = n.variation, d = n.offsets, y = n.position, b = n.gpuAcceleration, M = n.adaptive, j = n.roundOffsets, I = n.isFixed, P = d.x, N = P === void 0 ? 0 : P, B = d.y, R = B === void 0 ? 0 : B, k = typeof j == "function" ? j({
                    x: N,
                    y: R
                }) : {
                    x: N,
            ...
            function ts(n) {
                var e, t = Ce(n), i = _n(n), o = (e = n.ownerDocument) == null ? void 0 : e.body, c = Pe(t.scrollWidth, t.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), d = Pe(t.scrollHeight, t.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), y = -i.scrollLeft + En(n), b = -i.scrollTop;
            ...
            function Ai(n) {
                var e = n.reference, t = n.element, i = n.placement, o = i ? xe(i) : null, c = i ? lt(i) : null, d = e.x + e.width / 2 - t.width / 2, y = e.y + e.height / 2 - t.height / 2, b;
                switch (o) {
                case te:
                    b = {
                        x: d,
            ...
            function hs(n) {
                ...
                if (K) {
                    if (c) {
                        var ie, We = V === "y" ? te : ne, Be = V === "y" ? re : oe, ae = V === "y" ? "height" : "width", me = K[V], Zt = me + k[We], Ye = me - k[Be], Jt = N ? -q[ae] / 2 : 0, Rn = U === Ie ? G[ae] : q[ae], St = U === Ie ? -q[ae] : -G[ae], qt = e.elements.arrow, pt = N && qt ? mn(qt) : {
                            width: 0,
                            height: 0
                        }, Le = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : yi(), Mt = Le[We], en = Le[Be], Ge = At(0, G[ae], pt[ae]), Vn = X ? G[ae] / 2 - Jt - Ge - Mt - Z.mainAxis : Rn - Ge - Mt - Z.mainAxis, oc = X ? -G[ae] / 2 + Jt + Ge + en + Z.mainAxis : St + Ge + en + Z.mainAxis, Hn = e.elements.arrow && bt(e.elements.arrow), sc = Hn ? V === "y" ? Hn.clientTop || 0 : Hn.clientLeft || 0 : 0, mr = (ie = ee == null ? void 0 : ee[V]) != null ? ie : 0, ac = me + Vn - mr - sc, lc = me + oc - mr, gr = At(N ? Ht(Zt, ac) : Zt, me, N ? Pe(Ye, lc) : Ye);
                        K[V] = gr,
                        ye[V] = gr - me
                    }
                    if (y) {
                        var vr, cc = V === "x" ? te : ne, dc = V === "x" ? re : oe, Ue = K[F], tn = F === "y" ? "height" : "width", xr = Ue + k[cc], _r = Ue - k[dc], kn = [te, ne].indexOf(Y) !== -1, Er = (vr = ee == null ? void 0 : ee[F]) != null ? vr : 0, br = kn ? xr : Ue - G[tn] - q[tn] - Er + Z.altAxis, Ar = kn ? Ue + G[tn] + q[tn] - Er - Z.altAxis : _r, jr = N && kn ? Wo(br, Ue, Ar) : At(N ? br : xr, Ue, N ? Ar : _r);
                        K[F] = jr,
                        ye[F] = jr - Ue
                    }
            ...
            function gs(n, e, t) {
                ...
                return (i || !i && !t) && ((ve(e) !== "body" || bn(c)) && (y = ys(e)),
                ce(e) ? (b = at(e, !0),
                b.x += e.clientLeft,
                b.y += e.clientTop) : c && (b.x = En(c))),
                {
            ...
            class He extends he {
                ...
                hide() {
                    !this._isShown || this._isTransitioning || x.trigger(this._element, pa).defaultPrevented || (this._isShown = !1,
                    this._isTransitioning = !0,
                ...
                _triggerBackdropTransition() {
                    if (x.trigger(this._element, ha).defaultPrevented)
                        return;
                    const t = this._element.scrollHeight > document.documentElement.clientHeight
                      , i = this._element.style.overflowY;
                    i === "hidden" || this._element.classList.contains(Sn) || (t || (this._element.style.overflowY = "hidden"),
                    ...
                    for (const t of e)
                        if (t === "click")
                            ...
                            x.on(this._element, o, this._config.selector, c=>{
                                const d = this._initializeOnDelegatedTarget(c);
                                d._activeTrigger[c.type === "focusout" ? Cn : wt] = d._element.contains(c.relatedTarget),
                                d._leave()
                            }
                            )
                        }
            ...
            class Ke extends he {
                ...
                _keydown(e) {
                    if (![Hl, cr, kl, dr, Dn, ur].includes(e.key))
                        return;
                    e.stopPropagation(),
                    e.preventDefault();
            ...
            class Ot extends he {
                ...
                show() {
                    if (x.trigger(this._element, ec).defaultPrevented)
                        return;
                    this._clearTimeout(),
    ...
    const Sr = zn(Or)
      ...
      , Wn = (Q,z=!1)=>{
        ...
        return Q.style.setProperty("--submenu-height", f + "px"),
        f
    }
    ;
    class Mr {
    ...
    const Bn = Q=>{
        if (!ft)
            return;
        Ct(window) && (Q.classList.add("active"),
        Q.classList.add("sidebar-desktop"));

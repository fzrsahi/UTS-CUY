                                            ...
                                            <tbody>
                                                @foreach ($users as $user)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href ="/users/{{ $user['id'] }}" class="bi bi-pencil-fill">
                                                            </a>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="myModalLabel33">Tambah User
                                                                </h4>
                                                        ...
                                                        name="kategori"> -->
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input id="password" type="password"
                                                                            ...
                                                                            class="form-control hide" name="password"
                                                                            required>
                                                                        <a type="button" id="showPasswordBtn"
                                                                            class="bi bi-eye"
                                    ...
                                    <div class="card h-100 col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 mb-5 g-0"
                                        ...
                                        <div class="card-content ">
                                            @if (filter_var($row->foto, FILTER_VALIDATE_URL))
                                                <img class="card-img-top border rounded" src="{{ $row->foto }}"
                                        ...
                                        <ul class="list-group list-group-flush mb-5">
                                            ...
                                            <a href="/userview/{{ $row['id'] }}"
                                                class="text-center btn btn-primary">View</a>
                                        </ul>
                                    </div>
                                @endforeach
                            </div>

                ...
                <div class="row g-0 ">
                    <div class="col-md-4 bg-dark" style="height: 500px;">
                        @if (filter_var($data->foto, FILTER_VALIDATE_URL))
                            <img src="{{ $data->foto }}" class="card-img-top mw-100 h-100 object-fit-fill " alt="...">
                        @else
                            <img src="{{ asset('user-photos/' . $data->foto) }}"
                    ...
                    <div class="col-md-8 bg-light">
                        <div class="card-body  text-dark">
                            ...
                            <a href="/users/{{ $data['id'] }}" class="btn text-light d-sm-block bg-primary"
                                style="margin-bottom: -80px">EDIT</a>

                            <a href="/users" class="btn text-light d-sm-block bg-danger"
                                style="margin-top: 90px">KEMBALI</a>
                        </div>
                    </div>
                </div>
            </div>

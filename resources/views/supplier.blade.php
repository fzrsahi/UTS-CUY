                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex flex-wrap justify-content-between">
                                    ...
                                    <button type="button" class="btn btn-outline-success bg-dark" data-bs-toggle="modal"
                                        ...
                                        <tbody>
                                            @foreach ($suppliers as $supplier)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/products-management/{{$supplier['id']}}"class="bi bi-pencil-fill"></a>
                                                        <span>or</span>
                                                        <a href="#" class="bi bi-trash text-danger delete" data-id="{{ $supplier->id }}"data-nama="{{ $supplier->nama }}""></a> 
                                                    </td>
                                                </tr>
                                                @endforeach
                                        </tbody>
            ...
            <div class="modal-content">
                ...
                <form action="/suppliers" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input id="nomor_telepon" type="text" placeholder="Email" class="form-control" name="nomor_telepon" required>
                        </div>
                        <label for="stok">Alamat : </label>
                        <div class="form-group">
                            <input id="alamat" type="text" placeholder="Alamat" class="form-control" name="alamat" required>
                        </div>
